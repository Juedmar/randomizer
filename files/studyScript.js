...
if (confirm('Replace everything with Sample Questions N°1 (15)?')) {
 resetTrivia();
 sampleQs1();
 }
}
...
document.getElementById("randomQs").innerHTML = "Sample questions (1) ready.<br>Start studying!";
...
// STUDY TEMPLATE
function study___X___() {
document.getElementById("questAmount").value = "15";
document.getElementById("randomQs").innerHTML = "_____ questions (1) ready.<br>Start studying!";
